  ...
  parameter (nmax1=10**7,nmax2=5000)
  ...
  real(kind=8):: Ek(nmax1),me,qe,dE,Ek_max,int_v,int_E,fE,fE_min,Ek_all,amu,mass,sum_Ek
  character:: pnum*1
...
999 print*, '# of particles=',cnt
  ...
  do i=1,cnt
     ...
     Ek_tmp= vx(i)*vx(i) + vy(i)*vy(i) + vz(i)*vz(i)
     ...
     nEk(INT(Ek(i)/dE))=  nEk(INT(Ek(i)/dE)) +1  
...
10 continue
  ...
  do i=-nmax2,nmax2
     ...
     if( (i+nmax2).eq. INT(Ek_max/dE) ) fE_min= fE
...
subroutine generate_gnuplot(xmax,x0,Tp,ymin,pnum)
  ...
  write(10,*) 'set style line 1 lt rgb "red" lw 3 # red'
  write(10,*) 'set style line 2 lt rgb "green" lw 3 # green'
  write(10,*) 'set style line 3 lt rgb "blue" lw 3 # blue'
  write(10,*) 'set style line 4 lt rgb "purple" lw 3 # purple'
  write(10,*) 'set style line 5 lt rgb "#4dbeee" lw 3 # light blue'
  write(10,*) 'set style line 6 lt rgb "yellow" lw 3 # yellow'
  write(10,*) 'set style line 7 lt rgb "black" lw 3 # black'
  write(10,*) 'set style line 8 lt rgb "black" lw 5 # thick black'
  write(10,*) ' '
